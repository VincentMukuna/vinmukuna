...
function Hero() {
  return (
    <div className="mb-8 flex w-full flex-wrap items-center justify-center gap-8 lg:justify-between">
      <div className="order-2 flex flex-col items-center gap-y-8 md:items-start">
        ...
        <Button
          size={'lg'}
          className="w-fit rounded-full text-lg dark:bg-emerald-700 dark:text-gray-100 dark:hover:bg-primary-500"
        >
          Reach Out
        </Button>
      </div>
      <div className="order-1 inline-flex w-[20rem] max-w-[25rem]  drop-shadow-lg lg:order-2 lg:w-1/2">
        <img
